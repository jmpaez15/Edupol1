...
public class UniversidadesQuery {
    ...
    public static final String QUERY_GET_GRUPOPROGRAMAS="select DISTINCT g_p.I_COD_GRUPO,g_p.C_DESCRIPCION  from GRUPO_PROGRAMA g_p inner join UNIVERSIDAD_PROGRAMA u_p on g_p.I_COD_GRUPO=u_p.I_COD_NIV_EST\n" +
                                                        "where u_p.I_COD_UNIV=? and u_p.I_COD_NIV_FOR=? and u_p.I_COD_NIV_EST=?";
    public static final String QUERY_GET_PROGRAMAS="select DISTINCT p.I_COD_PROGRAMA,p.C_DESCRIPCION  from PROGRAMAS p inner join UNIVERSIDAD_PROGRAMA u_p on p.I_COD_PROGRAMA=u_p.I_COD_NIV_EST\n" +
